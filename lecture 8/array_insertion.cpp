...
intersection; An intersection for this problem can be defined when both the 
...
The first '2' of first array matches with the first '2' of the second array. Similarly, the second '2' 
...
void intersection(int *a, int *c, int n, int m)
{
    for(int i = 0; i < n; i++)
    {
        for(int j = 0; j < m; j++)
